...
#include "UI_Base.h"
#include "UI_Audio_Pitch.generated.h"
...
class PROJECTSOUND_API UUI_Audio_Pitch : public UUI_Base
{
	GENERATED_BODY()
	
public:
	static constexpr auto RESOURCE_PATH = TEXT("UI/UI_Audio_Pitch");
...
public:
	...
	UTextBlock* txt_pitch;

	UPROPERTY(meta = (BindWidget))
	USlider* slider_pitch;

	UPROPERTY(meta = (BindWidget))
	UEditableText* edtxt_pitch;

	UPROPERTY(meta = (BindWidget))
	UPSButton* btn_pitch_minus;

	UPROPERTY(meta = (BindWidget))
	UPSButton* btn_pitch_plus;
